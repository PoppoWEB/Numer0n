...
public class ServerFormat extends StackPane {
    ...
    public ServerFormat(FlashText waitText, Text titleText, Runnable filterOn, Runnable filterOff, Pane mainPane) {
        ...
        Label titleLabel = new Label("ゲーム開催");
        ...
        ipAddressField.setText(getMyAddress());
        ...
        new Thread(new Runnable() {
            public void run() {
                try {
                    waitText.setVisible(true);
                    Thread.sleep(4000);
                    WaitingServer ws = new WaitingServer(getPassword(), 60000, Human.getMyHuman());
                    
                    waitText.setText("マッチング");
                    
                    Thread.sleep(5000);
                    
                    OnLineInputScene numberScene = new OnLineInputScene(ws.getEnemyHuman(), ws.getServer());
